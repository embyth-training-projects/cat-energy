...
gulp.task('watch', function () {
  ...
  gulp
    .watch('./source/fonts/**/*.{ttf,woff,woff2}')
    .on('all', gulp.series('fonts', 'copyfonts', browserSync.reload));
  gulp
    .watch('./source/js/**/*.js')
    .on('all', gulp.series('scripts', browserSync.reload));
  gulp.watch('./source/sass/**/*.{sass,scss}').on('all', gulp.series('styles'));
  gulp
    .watch('./source/img/**/*.{jpg,png,svg}')
    .on('all', gulp.series('images', browserSync.reload));
  gulp
    .watch('./source/img/icons/**/*.svg')
    .on('all', gulp.series('svgsprite', browserSync.reload));
  gulp
    .watch('./source/img/content/**/*.{png,jpg}')
    .on('all', gulp.series('webp', browserSync.reload));
});
